...
const solGrueso = new Roofs ("Sol", 0.60, 0.60, 335, "cielorraso fijo");
const mediterraneoGrueso = new Roofs ("Mediterraneo", 0.60, 0.60, 335, "cielorraso fijo");
const alicanteGrueso = new Roofs ("Alicante", 0.60, 0.60, 335, "cielorraso fijo");
